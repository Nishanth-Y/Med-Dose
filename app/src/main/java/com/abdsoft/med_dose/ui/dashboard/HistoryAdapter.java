...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.textViewRemain.append(historyItem.getRemain());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        MaterialTextView textViewName, textViewDate, textViewTimesPerDay, textViewDosage, textViewTimings, textViewRemain;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            textViewRemain = itemView.findViewById(R.id.medicine_remain);
        }
    }
}
